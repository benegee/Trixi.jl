...
renderView1.ViewSize = [660, 1132]
renderView1.AxesGrid = 'Grid Axes 3D Actor'
renderView1.StereoType = 'Crystal Eyes'
renderView1.CameraPosition = [0.0, 0.0, 56.10696367924845]
renderView1.CameraFocalDisk = 1.0
renderView1.CameraParallelScale = 14.853647834605827
...
renderView2.ViewSize = [660, 1132]
renderView2.AxesGrid = 'Grid Axes 3D Actor'
renderView2.StereoType = 'Crystal Eyes'
renderView2.CameraPosition = [0.0, -0.311421059789995, 56.1060994030776]
renderView2.CameraViewUp = [0.0, 0.9999845959197544, 0.00555048855557971]
renderView2.CameraFocalDisk = 1.0
renderView2.CameraParallelScale = 14.853647834605827
